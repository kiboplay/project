...
function BackgroundCircles({}: Props) {
  return (
    ...
    >
      ...
      <div className="rounded-full border border-[#17ff1f]  h-[360px] w-[360px] absolute mt-52 md:w-[560px] md:h-[560px] opacity-20 flex justify-center items-center animate-pulse" />
    </motion.div>
  );
}
